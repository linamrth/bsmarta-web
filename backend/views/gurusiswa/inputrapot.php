...
<div class="row">
	<h3>Form Perkembangan Hasil Belajar Siswa : <?php echo $nmsiswa['namalengkap'].' - '.$nmprogram['namaprogram'].' '.$lvprogram['level'];?> </h3>
	<hr>
	...
	<?php $form = ActiveForm::begin();?>
		...
		<?php echo Html::a('Kembali', ['view','id'=>$back], ['class'=>'btn btn-info']);?>
