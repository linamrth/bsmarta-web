...
?>
<div class="row">
	<h2> Parameter Rapot Trial - Cinta Matika </h2>
		...
		<div class="panel panel-default">
			<div class="panel-heading">Kemampuan Belajar</div>
				...
				<div class="col-sm-6">
					...
					<?= $form->field($model, 'soal2')->radioList(['Baik' => 'Baik', 'Cukup' => 'Cukup', 'Kurang' => 'Kurang']) ?>
					<?= $form->field($model, 'soal3')->radioList(['Baik' => 'Baik', 'Cukup' => 'Cukup', 'Kurang' => 'Kurang']) ?>
