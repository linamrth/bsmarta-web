...
class PimpinanpembayaranController extends \yii\web\Controller
{
    ...
    public function actionPembayaranglobal()
    {
        ...
        if($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            $connection = Yii::$app->getDb();
            $command = $connection->createCommand("
                SELECT siswa.namalengkap, program.namaprogram, program.biayakursus, programlevel.level, pembayaran.tanggal, pembayaran.statuspembayaran
                FROM pembayaran
